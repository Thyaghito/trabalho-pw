...
public class UsersController implements Serializable {
    ...
    //nao tem!!!!!!!!!!!!!
    public String editUserSystem(){
        FacesContext fc = FacesContext.getCurrentInstance();
        ExternalContext ec = fc.getExternalContext();
        HttpSession sessao = (HttpSession) ec.getSession(true);
        current = (Users) sessao.getAttribute("sys_user");
        return "/users/Create";
    }
    //DIFERENTEEEEEEEEE!
    ...
    public Users getUser(String username) {          
        //return getFacade().find((java.lang.Integer)1);
        Users user = getFacade().findNamedQuery("Users.findByUsername", "username", username); 
        if(user!=null){
            return (Users)user;
        }
        return null;      
